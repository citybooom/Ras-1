...
void setup(void)
{
  ...
  base0a = analogRead(A0);
  base1a = analogRead(A1);
  base2a = analogRead(A2);
  base3a = analogRead(A3);
  ...
  base0b = analogRead(A0);
  base1b = analogRead(A1);
  base2b = analogRead(A2);
  base3b = analogRead(A3);
  ...
  base0c = analogRead(A0);
  base1c = analogRead(A1);
  base2c = analogRead(A2);
  base3c = analogRead(A3);
  ...
  base0d = analogRead(A0);
  base1d = analogRead(A1);
  base2d = analogRead(A2);
  base3d = analogRead(A3);
  ...
  base0e = analogRead(A0);
  base1e = analogRead(A1);
  base2e = analogRead(A2);
  base3e = analogRead(A3);
