...
for c = 3:1:13
    ...
    files2read{(c-2)} = strcat(files2read{c-2},"_Take2A.txt");
end
...
error_slopes = measure_ratios - ratios_3;
for k = 1:11
    for i = 1:11
        for j = 1:7
            matcharray(i,k) = ratios_3(i,j) - measure_ratios(k,j);
        end
    end
end
...
% ratios_2 = ratios_2 + measure_ratios;
hold off
